...
GENERATION_MODEL = os.getenv("GENERATION_MODEL", "edededi/hikelogic-qwen2.5-7b")
GENERATION_BACKEND = os.getenv("GENERATION_BACKEND", "local")  # "local" | "hf_api"
GENERATION_LOAD_4BIT = os.getenv("GENERATION_LOAD_4BIT", "1") == "1"
GENERATION_PROVIDER = os.getenv("GENERATION_PROVIDER", "auto")
GENERATION_MAX_TOKENS = int(os.getenv("GENERATION_MAX_TOKENS", "300"))
